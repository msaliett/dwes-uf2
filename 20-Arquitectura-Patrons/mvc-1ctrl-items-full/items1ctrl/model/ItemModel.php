...
require_once 'persist/ItemFileDao.php';
...
class ItemModel {
    ...
    public function __construct() {
        ...
        //$this->dataSource = new ItemFileDao("data/items.txt");
    ...
    public function searchByTitle(String $pattern): array {
        return $this->dataSource->selectWhereTitle($pattern);
    }
